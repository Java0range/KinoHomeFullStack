...
const getUserPermissionsString = (permissions: UserPermission) => {
    switch (permissions) {
...
export const Header: React.FC<HeaderProps> = ({userPermissions}) => {
    return (
        <header className="h-16 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-6">
            ...
            <div className="text-right">
                    <p className="text-sm font-medium text-white">{getUserPermissionsString(userPermissions)}</p>
                </div>
